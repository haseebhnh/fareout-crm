...
//
// Every delivery carries an `X-Fareout-Crm-Signature` header so receivers
// can verify the request really came from Fareout CRM and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-Fareout-Crm-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-Fareout-Crm-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a Fareout-CRM-to-Fareout-CRM integration
