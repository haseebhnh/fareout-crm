...
//
// Every delivery carries an `X-Ootrix-Crm-Signature` header so receivers
// can verify the request really came from Ootrix CRM and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-Ootrix-Crm-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-Ootrix-Crm-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a Ootrix-CRM-to-Ootrix-CRM integration
