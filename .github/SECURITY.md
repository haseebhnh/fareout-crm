...
- [GitHub Security Advisories](https://github.com/ArnasDon/ootrix-crm/security/advisories/new)
...
In scope:
- Anything in this repository (`ArnasDon/ootrix-crm`), including webhook and auth
