...
```bash
# 1. Fork on GitHub: https://github.com/ArnasDon/ootrix-crm → Fork
# 2. Clone your fork
...
```bash
git remote add upstream https://github.com/ArnasDon/ootrix-crm.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/ArnasDon/ootrix-crm/issues/new?template=bug_report.yml)
...
- Rebrand. The "CRM Template for WhatsApp" name, favicon, and
  `ootrix-crm.tech` URL belong to the upstream project; please swap them
