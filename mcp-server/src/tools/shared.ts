...
// layer dumb). On a FareoutCrmApiError we return an `isError` result with
...
import { FareoutCrmApiError } from '../client.js';
...
/**
 * Wrap a tool handler so any FareoutCrmApiError becomes a clean, model-
